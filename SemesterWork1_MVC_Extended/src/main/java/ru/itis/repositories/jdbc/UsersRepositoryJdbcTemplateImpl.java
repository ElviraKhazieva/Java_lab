...
//            " email, hash_password, confirm_code, state) values (:nickname, :firstName, :lastName, :birthDate, :email, " +
//            ":hashPassword, :confirmCode, :state)";
//
//    //language=PostgreSQL
...
//            "confirm_code = :confirmCode, state = :state  where id = :id";
//
//    //language=PostgreSQL
...
//
//    //language=PostgreSQL
//    private static final String SQL_SELECT_USER_BY_CONFIRM_CODE = "select * from simple_user where confirm_code = :confirmCode";
//
//    @Autowired
...
//        params.put("followerId", userFrom.getId());
...
//        try {
//            return Optional.of(jdbcTemplate.queryForObject(SQL_SELECT_USER_BY_CONFIRM_CODE,
//                    Collections.singletonMap("confirmCode", confirmCode),
//                    userRowMapper));
//        } catch (EmptyResultDataAccessException e) {
//            return Optional.empty();
//        }
