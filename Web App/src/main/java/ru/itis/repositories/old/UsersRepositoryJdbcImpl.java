...
//                entity.getGroupNumber(), entity.getEmail(), entity.getHashPassword());
//        entity.setId(id);
//    }
//
//    @Override
...
//                entity.getGroupNumber(), entity.getEmail(), entity.getHashPassword(), entity.getId());
//    }
//
//    @Override
...
//        List<User> users = template.SelectQuery(SQL_FIND_BY_LOGIN, userRowMapper, email);
//        if (users.size() > 0) {
